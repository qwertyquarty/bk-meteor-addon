...
## Modules
 ...
 - `VanishDetect`: Uses multiple methods to detect if a player is in vanish mode. This includes /vr list, which requires vivecraft, and the server's player info updates.
...
## Commands
 ...
 - `.vanished`: Shows vanished players on the servert, gets settings from and requires VanishDetect.
